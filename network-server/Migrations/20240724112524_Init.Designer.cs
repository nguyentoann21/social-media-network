            ...
            modelBuilder.Entity("network_server.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("a2cb2f06-3510-441a-92ef-4dda2b6125db"),
                            RoleName = "Manager"
                        },
                        new
                        {
                            RoleId = new Guid("25bd421b-a401-4d55-a2c0-9c5e6f619012"),
                            RoleName = "Employee"
                        },
                        new
                        {
                            RoleId = new Guid("ee5fcaaa-5da1-4793-9044-16b089257859"),
                            RoleName = "User"
                        });
                });
